...
{
cons1 = document.getElementById("con1").value; 
cons2 = document.getElementById("con2").value; 
var i
var j
                   ...
                   switch (cmdarr[1]) {
                       ...
                       case "alpha":  
                         if(fld.value.length>0 && fld.value.search("[^A-Z a-zÑñéáíóú0-9]") >= 0) { 
                              if (!msg || !msg.length)
                                 msg = "Por favor ingrese solo letras de la A la Z en minuscula o mayuscula y/o numeros en el Campo Asunto!";
                              window.alert(msg);
                              fld.focus();
                              fld.select();
                              return false;
                         ...
                         if(fld.value.length<2 ) { 
                              if (!msg || !msg.length)
                                 msg = "Por favor ingrese mas de 2 letras y/o numeros en el Campo Asunto!";
                              window.alert(msg);
                              fld.focus();
                              fld.select();
                              return false;
