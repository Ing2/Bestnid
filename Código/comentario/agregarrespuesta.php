...
$usuariocomentario = $_POST['idcomentario'];
$subastacomentario =  $_POST['idsubasta'];
$fechacom=date("Y-m-j");
$idsubasta =  $_POST['idsubasta'];



$respuesta = new Respuesta(null,$usuariocomentario,$idusuario,$cuerpo,$fechacom,1);

$dardealta=Respuesta::altaRespuesta($respuesta);
...
$agreguerespuesta='Se agrego la respuesta correctamente';
...
'comentarios'=>$comentarios,'tipo'=>$tipo,'agreguerespuesta'=>$agreguerespuesta,'subastasrandom'=>$subastasRandom, 'Contacto'=>$contacto,
