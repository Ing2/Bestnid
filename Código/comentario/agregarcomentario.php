...
$fechacom=date("Y-m-j");
$idsubasta =  $_POST['idsubastacomentario'];



$comentario = new comentario(null,$cuerpo,$fechacom,$usuariocomentario,$subastacomentario,1);

$dardealta=Comentario::altaComentario($comentario);
