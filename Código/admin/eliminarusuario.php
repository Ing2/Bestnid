...
if (($ofertas= Subasta::tieneOferta($subasta)) == 0){
	...
	$mensaje="la subasta no puede eliminarse porque tiene ofertas en curso";
}
...
'AgregarAdmin' => 'Gestion de Administradores','notienesubastas'=>$notienesubastas, 'Contacto'=>$contacto,
'elimino'=>$elimino,'AltaAdmin'=>'Agregar administrador',
));
